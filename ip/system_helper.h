...
class SystemHelper {
public:
    static int system_ex(const char *cmdstring, unsigned int timeout)   /* with appropriate signal handling */
    {
        pid_t               pid;
        int                 status;
    ...
    static int get_cmd_results(const char *cmdstring, char *buff, int size)
    {
